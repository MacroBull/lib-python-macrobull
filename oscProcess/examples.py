...
sTek0=tek.loadWaveFromFile('/home/macrobull/workspace/Python/oscLibTest/tek/F0002CH1.CSV')
sTek1=tek.loadWaveFromFile('/home/macrobull/workspace/Python/oscLibTest/tek/F0002CH2.CSV')
sRigol0=rigol.loadWaveFromFile('/home/macrobull/workspace/Python/oscLibTest/rigol/(13).csv')
sRigol1=rigol.loadWaveFromFile('/home/macrobull/workspace/Python/oscLibTest/rigol/(15).csv')
...
subplot(221)
sNeo0.plotWave()
peakAnnotator(sNeo0.t,sNeo0.ch1,minDiff=16)
subplot(222)
sNeo0.plotLissajous()
subplot(223)
